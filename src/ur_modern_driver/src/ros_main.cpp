...
bool parse_args(ProgArgs &args)
{
  ...
  ros::param::param(MAX_VEL_CHANGE_ARG, args.max_vel_change, 1.0);  // 15 old rad/s
  ros::param::param(MAX_VEL_CHANGE_ARG, args.max_velocity, 1.0); // 10.0 old
  ros::param::param(ROS_CONTROL_ARG, args.use_ros_control, false);
  ros::param::param(LOW_BANDWIDTH_TRAJECTORY_FOLLOWER, args.use_lowbandwidth_trajectory_follower, true);
